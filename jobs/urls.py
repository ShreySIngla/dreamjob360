...
from .views import registration_view,index,login_view,about,contact,profile,job_list,search_list,JobDetailView,subscribe,emp_registration,emp_login,post_job,emp_index,JobDeleteView,emp_job_list,applied_candidates,candidate_profile,latest_blogs,PostDetail,appliedjobs
from . import views
